...
public class BayesClassifier extends AbstractClassifier implements Serializable {
    ...
    public void fS_CS(float percent) {
        featureSelectionChiSquare(percent);
    }
    ...
    public void fS_CS_Max(float percent) {
        featureSelectionChiSquareMax(percent);
    }
    ...
    public void fS_IG(float percent) {
        featureSelectionInformationGain(percent);
    }
