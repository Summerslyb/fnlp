...
public class FeatureSelect {
     ...
     * @param percent 保留百分比
     */
    public void fS_CS_Max(ItemFrequency tf, float percent) {
        featureSelectionChiSquareMax(tf, percent);
    }
     ...
     * @param percent 保留百分比
     */
    public void fS_IG(ItemFrequency tf, float percent) {
        featureSelectionInformationGain(tf, percent);
    }
